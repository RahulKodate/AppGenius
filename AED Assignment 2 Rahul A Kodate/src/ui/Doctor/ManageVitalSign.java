...
public class ManageVitalSign extends javax.swing.JPanel {
  ...
  private void initComponents() {
    ...
    lblLanding1.setFont(new java.awt.Font("Operator Mono", 1, 24)); // NOI18N
    ...
    btnSearchAbnormal.setBackground(new java.awt.Color(51, 102, 255));
    ...
    lblLanding3.setFont(new java.awt.Font("Operator Mono", 1, 24)); // NOI18N
    ...
    btnAddVitals.setBackground(new java.awt.Color(51, 102, 255));
    btnAddVitals.setFont(new java.awt.Font("Operator Mono", 1, 13)); // NOI18N
    ...
    btnViewEncounters.setBackground(new java.awt.Color(51, 102, 255));
    btnViewEncounters.setFont(new java.awt.Font("Operator Mono", 1, 13)); // NOI18N
    ...
    btnSearchComm.setBackground(new java.awt.Color(51, 102, 255));
    btnSearchComm.setFont(new java.awt.Font("Operator Mono", 1, 13)); // NOI18N
    ...
    btnRefreshPatients.setBackground(new java.awt.Color(51, 102, 255));
    btnRefreshPatients.setFont(new java.awt.Font("Operator Mono", 1, 13)); // NOI18N
